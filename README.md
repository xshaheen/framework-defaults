...
This is the `Framework.Defaults` package, which provides the standard configurations and settings for the Framework projects. Such as `.editorconfig`, build props and targets.
